...
export default function Contact() {
    ...
    const email = 'dk1816859@gmail.com'; 
    ...
    const contacts = [
        {
            name: 'GitHub',
            icon: Github,
            value: 'github.com/Deepakthakur10',
            link: 'https://github.com/Deepakthakur10',
            color: 'text-text-primary dark:text-dark-text-primary'
        },
        {
            name: 'LinkedIn',
            icon: Linkedin,
            value: 'linkedin.com/in/deepakthakur078',
            link: 'https://linkedin.com/in/deepakthakur078',
            color: 'text-[#0077b5]'
        }
    ];
        ...
        <div className='max-w-3xl mx-auto space-y-12'>
            <div className='space-y-4'>
                <div className='flex items-center gap-4'>
                    ...
                    <h2 className='text-sm font-mono uppercase tracking-[0.3em] font-bold text-arch-blue'>Let's Connect</h2>
                    <div className='h-px flex-1 bg-border dark:bg-dark-border' />
                </div>
            </div>
            ...
            <div className='grid gap-4'>
                {contacts.map((item, i) => (
                    <motion.div
                        ...
                        className='group p-5 bg-black/5 dark:bg-white/5 border border-border dark:border-dark-border rounded-xl flex items-center justify-between hover:border-arch-blue/40 transition-all backdrop-blur-sm hover:shadow-lg hover:shadow-arch-blue/10'
                    >
            ...
            <motion.div
                ...
                className='p-8 bg-black/5 dark:bg-white/5 border border-border dark:border-dark-border rounded-2xl flex flex-col md:flex-row items-center justify-between gap-6 hover:border-arch-blue/30 transition-all'
            >
                <div className='space-y-3 text-center md:text-left'>
                    <div className='flex items-center justify-center md:justify-start gap-3 text-muted'>
                        ...
                        <h3 className='text-xs font-mono font-bold tracking-widest'>EMAIL</h3>
                    </div>
                    <p className='text-xs text-arch-blue font-mono font-bold'>{email}</p>
