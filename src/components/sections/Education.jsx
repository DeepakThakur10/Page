...
const EDUCATION = [
    ...
    {
        institution: "B.M.H.S",
        location: "Simri, Darbhanga, Bihar, India",
        degree: "Matriculation",
        period: "Apr 20 - Mar 21",
        metrics: "Percentage: 82.20%",
        type: "school"
    }
];
            ...
            >
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                    ...
                    <div className='p-4 bg-arch-blue/5 border border-arch-blue/20 rounded-lg hover:border-arch-blue/40 transition-all'>
                        ...
                        <p className='text-sm font-medium'>5-Star Gold Rating</p>
                    </div>
                    <div className='p-4 bg-arch-blue/5 border border-arch-blue/20 rounded-lg hover:border-arch-blue/40 transition-all'>
                        <p className='text-xs font-mono uppercase tracking-wider text-arch-blue mb-2'>LeetCode Badge</p>
                        <p className='text-sm font-medium'>Introduction to Pandas</p>
                    </div>
                    <div className='p-4 bg-arch-blue/5 border border-arch-blue/20 rounded-lg hover:border-arch-blue/40 transition-all'>
                        <p className='text-xs font-mono uppercase tracking-wider text-arch-blue mb-2'>Oracle Cloud</p>
                        <p className='text-sm font-medium'>Data Science Certified</p>
                    </div>
                </div>
            </motion.div>
        </div>
