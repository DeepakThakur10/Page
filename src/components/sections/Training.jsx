...
const TRAININGS = [
    {
        id: 'android-summer-training',
        subject: 'Mobile Development',
        course: 'Android Developer Pro: Hands-On Projects',
        period: 'Jun 2025 - Jul 2025',
        status: 'completed',
        tags: ['Kotlin', 'Android', 'Firebase', 'XML'],
        highlights: [
            'Completed a practical Android development program, building real-world apps from scratch using Kotlin, XML, Firebase, and Android Studio.',
            'Developed production-ready apps featuring Fragments, RecyclerView, authentication, real-time data, and optimized UI/UX.',
            'Prepared apps for Play Store deployment with end-to-end skills in designing, coding, testing, debugging, and publishing.',
            'Gained hands-on experience publishing Android applications on the Google Play Store.'
        ]
    }
];
