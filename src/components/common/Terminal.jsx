...
const HELP_MESSAGE = `
Available commands:
  about           - Learn about Deepak Kumar Thakur
...
export default function Terminal({ onCommand, onClose }) {
    ...
    const [history, setHistory] = useState([
        { type: 'output', content: "Welcome to Deepak Thakur's Developer Portfolio" },
        ...
        >
            <div className='bg-black/5 dark:bg-black/40 px-4 py-2 flex items-center justify-between border-b border-border dark:border-dark-border'>
                <div className='flex items-center gap-3'>
                    ...
                    <span className='text-xs font-mono text-muted'>~/deepak.dev</span>
                </div>
