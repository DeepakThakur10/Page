        ...
        <header className='fixed top-0 left-0 right-0 h-8 flex items-center justify-between px-2 z-50 pointer-events-none'>
            <div className='flex items-center gap-1 pointer-events-auto'>
                ...
                >
                    ...
                    <span className='hidden sm:inline'>deekay.dev</span>
                </button>
                <button
                    onClick={() => onNavigate && onNavigate('home')}
                    className='waybar-module shadow-sm hover:bg-arch-blue/10 transition-colors cursor-pointer'
                >
                    <Layout size={12} className='text-arch-blue' />
                    <span className='capitalize truncate max-w-20 sm:max-w-none'>{activeWindow || 'Home'}</span>
                </button>
            </div>
            ...
            <div className='hidden lg:flex items-center gap-1 pointer-events-auto'>
                <div className='waybar-module border-transparent bg-transparent text-[12px]'>
                        Deepak Kumar Thakur | Software Engineer | Android Developer | MERN Developer | Data Enthusiast
                </div>
            </div>
